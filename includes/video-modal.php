	...
	<div class="modal-dialog modal-lg">
	   <div class="modal-content">
		   ...
		   <div class="embed-responsive embed-responsive-16by9">
				<iframe id="$playerID" class="embed-responsive-item" src="https://www.youtube.com/embed/$YTid?autoplay=0&showinfo=0&enablejsapi=1&origin=http://kate.sampelgrift.com" frameborder="0" allowfullscreen></iframe>
			</div>
