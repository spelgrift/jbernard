	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2 text-justify">
				...
				<p>I am drawn to Americana, roots music, vintage country, blues, and country rock… songs that are authentic and tell a story of people, places, and real experiences. When the band is in sync and we can make the music come alive through us, it’s a feeling like none other. Music raises the vibration of the planet. It’s an honor to connect with people in this way and make an audience happy.</p>
			</div>
		</div>
		<div class="row">
			<div class="col-md-8 col-lg-6 col-md-offset-2 col-lg-offset-3 text-center">
				<p class='testimonial'>"It was not just your voice that was so terrific, but your presence, your rhythm and body movements, your enthusiasm, and just a sparkle in your presentation that awed us all."–Dore G</p>
			</div>
		</div>

		<div class='row'>
			<div class="col-md-8 col-lg-6 col-md-offset-2 col-lg-offset-3 text-center">
				<p class='testimonial'>"I loved the band, the venue and YOUR SINGING, OMG!" -Bette C</p>
			</div>
		</div>
